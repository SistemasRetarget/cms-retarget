...
const SHORTCUTS = [
  { href: "/admin/cola-aprobacion", title: "Cola de aprobación", desc: "Revisar y publicar artículos por ámbito", icon: "\u{2705}" },
  { href: "/admin/collections/articles", title: "Artículos", desc: "Noticias publicadas, borradores y en revisión", icon: "\u{1F4F0}" },
  { href: "/admin/collections/sources", title: "Fuentes", desc: "RSS, sitios y sitemaps para recolectar", icon: "\u{1F517}" },
  { href: "/admin/collections/categories", title: "Categorías", desc: "Organización temática del contenido", icon: "\u{1F3F7}" },
  { href: "/admin/globals/ai-settings", title: "AI Settings", desc: "Credenciales Anthropic / Gemini / OpenAI", icon: "\u{1F916}" },
  { href: "/admin/collections/landing-pages", title: "Landings", desc: "Landing pages generadas con IA", icon: "\u{1F680}" },
  { href: "/admin/collections/media", title: "Medios", desc: "Imágenes y archivos", icon: "\u{1F5BC}" },
  { href: "/", title: "Ver sitio público", desc: "Blog de noticias", icon: "\u{1F310}" }
];
  ...
  return (
    <Gutter>
      <div className="pld-welcome">
        <h2>Hola, {userName}</h2>
        <p>
          Panel del blog de noticias con IA. Configura tus credenciales en <strong>AI Settings</strong>,
          agrega fuentes RSS y deja que la IA genere artículos automáticamente.
        </p>
      </div>
      ...
      <div style={{ background: "#fff", border: "1px solid #e8dfd0", borderRadius: 12, padding: "1.5rem 1.75rem", marginTop: "1rem" }}>
        ...
        <ol style={{ margin: 0, paddingLeft: "1.3rem", lineHeight: 1.8, color: "#4a3d2c" }}>
          <li>Abre <strong>AI Settings</strong> y pega tu API key (Anthropic, Gemini u OpenAI).</li>
